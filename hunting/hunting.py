...
class Hunting:
    def __init__(self, bot):
        ...
        self.animals = {'fox': ':fox: **_Ring-ding-ding-ding-dingeringeding!_**', 'deer': ':deer: **_Mewww!_**', 'turkey': ':turkey: **_Gobble!_**', 'jake': '<:jakewink:512674310498811920> **_Uh?_**', 'louise': '<:cheesy:509235063196745729> **_I-_**', 'woofer': '<:MyHeart:498387541578481685> **_ily!_**', 'spike': ':motorcycle: **_Vroom!_**'}
        self.in_game = []
        self.paused_games = []
